...
import { ApiExceptionFilter } from './support/exception/ApiExceptionFilter';
...
async function bootstrap() {
  ...
  const app = await NestFactory.create<NestExpressApplication>(ApiAppModule, { abortOnError: true });
