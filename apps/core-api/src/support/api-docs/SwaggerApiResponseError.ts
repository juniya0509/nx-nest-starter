...
type SwaggerErrorExampleInput =
  | (ApiError | CoreDomainError)
  | {
      error: ApiError | CoreDomainError;
      data?: unknown;
    };
...
export function SwaggerApiResponseError(status: number, examples: SwaggerErrorExampleInput[]) {
...
function isWrappedExample(value: SwaggerErrorExampleInput): value is { error: ApiError | CoreDomainError; data?: unknown } {
