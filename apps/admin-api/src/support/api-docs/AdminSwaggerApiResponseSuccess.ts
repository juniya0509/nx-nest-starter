...
export function AdminSwaggerApiResponseSuccess(status = 200, models: SwaggerSuccessModel | SwaggerSuccessModel[], description = '성공') {
  ...
  return applyDecorators(
    ApiExtraModels(AdminApiResponse, AdminApiErrorMessage, ...realModels),
    SwaggerApiResponse({
      status,
      description,
      content: {
