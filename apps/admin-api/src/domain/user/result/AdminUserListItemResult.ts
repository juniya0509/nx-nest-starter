...
type AdminUserListItemResultProps = {
  readonly id: number;
...
export class AdminUserListItemResult {
  private constructor(private readonly result: AdminUserListItemResultProps) {}
  ...
  static of(result: AdminUserListItemResultProps): AdminUserListItemResult {
    return new AdminUserListItemResult(result);
  }
}
